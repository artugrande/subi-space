...
- The source code of every contract, public on GitHub under the MIT licence and verified on Celoscan, Blockscout and Sourcify: anyone can check that what is deployed is exactly that.
